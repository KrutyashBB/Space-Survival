...
public class StartGameScene : Scene
{
    ...
    {
        _startGameBtn.Update(new Vector2(Globals.WindowSize.X / 2f - 185, Globals.WindowSize.Y / 2f));
        _controlSectionBtn.Update(new Vector2(Globals.WindowSize.X / 2f - 185, Globals.WindowSize.Y / 2f + 120));
    }
